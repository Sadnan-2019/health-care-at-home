...
const Nursing = () => {
     return (
          ...
          <section className=" bg-no-repeat bg-cover " style={{
               backgroundImage: `url("https://i.ibb.co/Wn6dzfF/Whats-App-Image-2022-10-01-at-12-08-00-PM.jpg")`,
             }}>
           <div className=" md:py-20 py-10 lg:py-24 lg:mx-16 mx-8 grid lg:grid-cols-1 grid-cols-1 gap-5">
             <div className="max-w-xl text-left md:ml-8 lg:order-1 order-2 mt-10 lg:mt-0">
               ...
               <p
                 ...
                 style={{ lineHeight: "120%",color:"#453364" }}
               >
                 Trained and experienced diploma nurses to help with daily activities and vitals monitoring at home.
               </p>
               <div className='flex items-center mt-5 font-bold' data-aos="fade-up"
