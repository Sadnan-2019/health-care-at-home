...
const CardiacSymptomsCauses = () => {
    return (
        ...
        <p className="px-10 py-2">
         ...
         <p className="px-10 py-2">
         Within the next 10 minutes, a doctor and a nurse
          ...
          at home as per their necessities.
         ...
         The global Covid-19 pandemic has
          ...
          played an important role in meeting the healthcare needs.
         ...
         <p className="px-10 py-2">
         The organization has brought home-based
         ...
         HCAH will then assess the patient’s health status
