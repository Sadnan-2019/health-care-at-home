  ...
  return (
    <div className="py-10">
      <div class="p-4 max-w-xl mx-auto dark:bg-gray-800">
        <h2 class="font-heading dark:text-gray-100 mb-8 text-center text-3xl font-bold lg:text-4xl">
        ...
        <div class="flex">
          ...
          <div class="pt-1 pb-8">
            <p class="mb-2 text-xl font-bold text-gray-900 dark:text-slate-300">
              COLLECT PATIENTS DOCUMENTATIONS
            </p>
            <p class="text-gray-600 dark:text-slate-400">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
              sagittis, quam nec venenatis lobortis, mirisus tempus nulla, sed
        ...
        <div class="flex">
          ...
          <div class="pt-1 pb-8">
            <p class="mb-2 text-xl font-bold text-gray-900 dark:text-slate-300">
              PATIENTS VISIT BY CEO WITH CAREGIVER
            </p>
            <p class="text-gray-600 dark:text-slate-400">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
              sagittis, quam nec venenatis lobortis, mirisus tempus nulla, sed
