...
const patientGroups = [
  ...
  },
  {
    ...
    icon: <FaWheelchair className="text-4xl text-primary" />,
    description:
  ...
  },
  {
    ...
    icon: <FaProcedures className="text-4xl text-primary" />,
    description:
  ...
  },
  {
    ...
    icon: <FaWalking className="text-4xl text-primary" />,
    description:
  ...
  },
  {
    ...
    icon: <FaUserNurse className="text-4xl text-primary" />,
    description:
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-14">
          ...
          <p className="mt-6 text-lg leading-8 text-base-content/80">
            ...
            need assistance with daily living activities while remaining in the
            comfort of their own home. Whether recovering from surgery, living
            with a chronic illness, caring for an elderly family member, or
            supporting someone with limited mobility, a trained caregiver can
            provide compassionate assistance that improves comfort, safety, and
            quality of life.
          </p>

          <p className="mt-4 text-base leading-8 text-base-content/80">
            At Healthcare at Home Bangladesh, our experienced caregivers support
            elderly individuals, stroke survivors, bedridden patients, people
            living with dementia, paralysis, Parkinson's disease, cancer, and
            other conditions requiring dependable home care. Every care plan is
            personalized to meet the patient's health condition, independence
            level, and family requirements.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {patientGroups.map((item) => (
            <article
              key={item.id}
              className="card bg-base-100 border border-base-300 hover:border-primary transition-all duration-300 hover:shadow-2xl"
            >
              <div className="card-body">
                <div className="mb-5">{item.icon}</div>

                <h3 className="card-title text-2xl mb-3">{item.title}</h3>
        ...
        {/* Why Early Care */}
        <div className="mt-20 rounded-3xl bg-primary text-primary-content p-8 lg:p-12">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="leading-8 opacity-95">
              ...
              <p className="mt-5 leading-8 opacity-95">
