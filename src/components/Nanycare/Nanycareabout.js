    ...
    <div className="w-full text-gray-800 font-sans">
      ...
      <section className="bg-slate-50 py-12 md:py-20">
        <div className="container mx-auto px-6 sm:px-10 lg:px-16 max-w-6xl">
          ...
          >
            Our comprehensive <strong className="font-semibold text-[#453364]">child care at home</strong> packages cover every critical domain of early childhood management to give your baby a safe, structured, and nurturing environment:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <ul className="space-y-3 poppins-t text-sm sm:text-base text-gray-700 pl-2">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#453364] font-bold mt-1">•</span>
                  <span>Umbilical cord cleaning and daily monitoring for early signs of infection.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#453364] font-bold mt-1">•</span>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <h4 className="font-bold poppins-b text-gray-900 mb-1">1. Cord Care</h4>
                <p className="text-xs sm:text-sm poppins-t text-gray-600">Keep dry and monitor daily until natural separation.</p>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <h4 className="font-bold poppins-b text-gray-900 mb-1">2. Thermal Control</h4>
                <p className="text-xs sm:text-sm poppins-t text-gray-600">Ensure proper swaddling; prevent hypothermia or overheating.</p>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <h4 className="font-bold poppins-b text-gray-900 mb-1">3. Jaundice Watch</h4>
                <p className="text-xs sm:text-sm poppins-t text-gray-600">Monitor skin tone and eye sclera under bright natural light.</p>
              </div>
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center">
                ...
                <h4 className="font-bold poppins-b text-gray-900 mb-1">4. Feeding Log</h4>
                <p className="text-xs sm:text-sm poppins-t text-gray-600">Track latch efficiency, bottle volumes, and daily wet diapers.</p>
              </div>
