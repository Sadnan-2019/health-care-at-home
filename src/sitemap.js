...
sitemap.write({ url: "/medical-assistant", changefreq: "weekly", priority: 0.8 });
sitemap.write({ url: "/medical-caregiver", changefreq: "weekly", priority: 0.8 });
...
sitemap.write({ url: "/medical-equipment", changefreq: "weekly", priority: 0.8 });
...
streamToPromise(sitemap).then((data) => fs.writeFileSync("public/sitemap.xml", data));
